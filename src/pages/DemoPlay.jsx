...
const audioRef=useRef(null);
  ...
  return (
    <div  style={{overflowX:'hidden'}}>
                <audio ref={audioRef} src={'https://gamesounds.xyz/OpenBundle/Background%20Music%20and%20Loops/King%20Boss%20%28loop%29.mp3'} loop autoPlay={localStorage.getItem('bg-status')!=='not-play'}  />
